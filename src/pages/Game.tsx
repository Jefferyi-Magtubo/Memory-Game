...
export default function Game() {
    ...
    return (
        ...
        <main className={`${endOfGame ? "pointer-events-none" : ""} bg-white3 p-4 h-screen flex flex-col justify-between`}>
            <header className="flex justify-between items-center">
                <div className="svg-container-game mt-2 w-32" aria-label="This is the logo for the game.">
                ...
                <button className="bg-darkYellow hover:bg-darkYellowHover font-athl text-white px-4 py-1 rounded-xl font-bold">Menu</button>
            </header>

            <section className="flex justify-center">
                <div className={`grid ${gridSize === "4x4" ? "grid-cols-4 gap-y-2 gap-x-2   w-max" : gridSize === "6x6" ? "grid-cols-6 gap-y-1  w-max" : ""} `}>
            ...
            <section>
                ...
                <div className="flex justify-center items-center">
                    <div className="bg-playerCardDefault flex flex-col font-athl justify-center items-center py-4 w-24 mr-4 rounded-lg">
            ...
            <div className={`${endOfGame ? "fixed inset-0 flex items-center justify-center bg-black bg-opacity-50" : "hidden"} `}>
                ...
                <div className={`bg-white w-4/5 p-6 flex-col justify-center items-center text-center rounded-lg pointer-events-auto ${players === 1 ? 'hidden' : ''}`}>
                    ...
                    <div className="flex flex-col mt-4">
                        <Link to="/" onClick={() => window.location.reload()} className="bg-darkYellow hover:bg-darkYellowHover  text-white3 font-bold p-2 rounded-3xl mb-2">Restart</Link>
                ...
                <div className={`bg-white w-4/5 p-6 flex-col justify-center items-center text-center rounded-lg pointer-events-auto ${players === 1 ? '' : 'hidden'}`}>
                    <h1 className="text-2xl text-darkBlack font-bold mb-2">You did it</h1>
                    <p className="text-xs text-lightBlue font-bold mb-4">Game Over! Here's how you got on...</p>
                    <div className="bg-playerCardDefault flex  font-athl justify-between items-center p-4 rounded-lg">
                        <h2 className="font-bold text-lightBlue text-xs">Time Elapsed</h2>
                    ...
                    <div className="bg-playerCardDefault flex  font-athl justify-between items-center p-4 rounded-lg mt-2">
                        <h2 className="font-bold text-lightBlue text-xs">Moves</h2>
                        <h1 className="font-bold text-darkGray text-xl">{moves}</h1>
                    </div>
                    <div className="flex flex-col mt-4">
                        <a onClick={() => window.location.reload()} className="bg-darkYellow hover:bg-darkYellowHover  text-white3 font-bold p-2 rounded-3xl mb-2">Restart</a>
                        <Link to="/" className="bg-playerCardDefault linkGray hover:bg-lightBlue2 hover:text-white text-darkGray p-2 rounded-3xl font-bold">Setup New Game</Link>    
                    </div>
                </div>
