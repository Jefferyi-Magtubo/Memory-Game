...
export default function Player({player, score, currentPlayer} : {player : number, score: { [key: number]: number }, currentPlayer : number}) {
    ...
    return(
        <>
            ...
            <div className={`${currentPlayer === player ? "bg-darkYellow md:current" : "bg-playerCardDefault"} p-4 w-16 flex flex-col items-center mr-4 font-athl player relative sm:hidden`}>
            ...
            <div className={`${currentPlayer === player ? "bg-darkYellow md:current" : "bg-playerCardDefault"} p-4 w-32 hidden sm:flex flex-col items-center mr-4 font-athl player relative `}>
